...
//        addView(footer, 2);
    ...
    public void setLoadDataListener(MyLoadListener mLoadListener)
    {
    ...
    @Override
    public void onScrollStateChanged(AbsListView listView, int scollState) {
        this.scollState=scollState;
        this.listView= (android.widget.ListView)listView;
    ...
    @Override
    public void onScroll(AbsListView listView, int firstVisbleItem, int VisbleItemCount, int totalItemCount) {
        this.listView= (android.widget.ListView) listView;
    ...
    public void loadDataComplete() //加载完毕
    {
        isLoading=false;
        footer.findViewById(R.id.loadmore).setVisibility(View.GONE);
    }
